...
public class RoomBuilder
{
    ...
    private readonly AssetsScript _assets;
    private readonly List<FloorTile> _floorCustomTiles;

    //
    private readonly RoomScript _room;
    private readonly List<WallTile> _wallCustomTiles;
    private readonly List<WallTile[,]> _wallTiles;
    private readonly Quaternion DefaultFloorRotation = Quaternion.identity;
    private readonly Quaternion DefaultWallRotation = Quaternion.identity;
    ...
    public void SaveData(string aFilePath)
    {
        ...
        var lData = new RoomData(_width, _height, _wallHeight, _doorPositions, _doorDefaultMaterial, _floorTileTypes,
